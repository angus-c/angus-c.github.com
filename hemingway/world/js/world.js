...
function draw(topo) {
  ...
  country.enter().insert("path")
      ...
      .style("fill", function(d, i) {
        return sites[d.properties.name] ? d.properties.color : "#AEAEAE"
      });
  ...
  country
    .on("mousemove", function(d,i) {
      ...
      .on("click", function(d,i) {
        var country = d.properties.name;
        if (sites[country]) {
          location.href = "http://www.amazon" + sites[country] + "/gp/product/1593275854/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1593275854&linkCode=as2&tag=ifhemwrojav-20&linkId=HEHXBBWQN7YSZSYD"
        }
      })
